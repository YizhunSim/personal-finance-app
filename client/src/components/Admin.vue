        ...
        <v-dialog v-model="dialog" max-width="500px">
          ...
          <v-card>
              ...
              <v-card-text>
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <v-select v-model="editedItem.STAT" :items="stat" label="Status" required></v-select>
                    </v-col>
                    ...
                    <v-col cols="12" sm="6" md="6">
                      <v-btn @click="autoGeneratePassword">Generate Password</v-btn>
                    </v-col>
                    <v-col cols="12" sm="6" md="6">
                      <v-text-field
                        v-model="password"
            ...
            <v-card-actions>
              ...
              <v-btn :disabled="!isFormValid" color="blue darken-1" text @click="save">Save</v-btn>
            </v-card-actions>
          </v-card>
        </v-dialog>
      </v-toolbar>
...
export default {
  ...
  methods: {
    ...
    editUpdateUsers(userId) {
      ...
      console.log(`isAdmin: ${this.users[userId].IS_ADMIN}`);
      this.$http
