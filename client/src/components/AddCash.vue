...
export default {
  ...
  data() {
    return {
      ...
      sumRules: [v => /^[0-9]*$/.test(v) || "Sum must only have numbers"]
    };
  },
  computed: {
    retrieveAccountId() {
  ...
  methods: {
    ...
    submitCash() {
      console.log(`AccountId: ${this.retrieveAccountId}, Source: ${this.source}, Sum: ${this.sum}, TransactionDate: ${this.date}, TransactionCategory: ${this.transactionCategory}, TransactionType: ${this.transactionType}
      `);
      this.$store
